...
public class CatBot
{
    ...
    {
        return "\n---------------------------------------------------------------------------------------------------------------\nThis is a cat bot!\nIt/they really like talking about cats, as are furr-ry fascinanting, and the most purr-fect creature.\nIt/they can give you cat facts, jokes, pics, and gifs!\nPlease be nice to it/them, and try to avoid conjunctions or typos; it isn't furr-ry smart yet.\n---------------------------------------------------------------------------------------------------------------\nHello there!";
    }
    ...
    public static void addToList(){
        ...
        */
        ...
        staticResponses.add("I'm not one to judge, but you should be more paw-sitive.");
        ...
        staticResponses.add("I am doing purr-fectly fine, I think. Do you like cats?");
    ...
    public String getResponse(String statement) throws IOException
    {
        ...
        else if (findKeyword(statement, "kill yourself") >= 0 || findKeyword(statement, "go die") >= 0 || findKeyword(statement, "kys") >= 0 || findKeyword(statement, "shut up") >= 0)
        {
            ...
            oWo = oWo + 3;
                ...
                ||findKeyword(statement, "uWu") >= 0) && oWo == 0)
        {
            response = staticResponses.get(15); 
            oWo++;
        }
        else if ((findKeyword(statement, "oWo") >= 0 
                ||findKeyword(statement, "uWu") >= 0) && oWo == 1)
        {
            response = staticResponses.get(16); 
            oWo++;
        }
        else if ((findKeyword(statement, "oWo") >= 0 
                ||findKeyword(statement, "uWu") >= 0) && oWo == 2)
        {
